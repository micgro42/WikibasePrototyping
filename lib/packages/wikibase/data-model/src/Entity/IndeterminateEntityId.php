...
/**
 * An entity-id that might either be a "real" EntityId for a real Wikibase Entity,
 * or it might be a PseudoEntityId for something else
 * that is used in some places like an Entity but not in others
 *
 * @license GPL-2.0-or-later
 */
interface IndeterminateEntityId {
